  ...
  return (
    <ul>
    {
      views.map((view, index) => {
        return <NavLink view={view} key={index} active={newView} onClick={onClick} style={style}/>
      })
    }
    </ul>
  )
...
const NavDrawer = ({ views, open, closeDrawer, newView }) => {
  const styles = {
    navDrawer: {
  ...
  return (
    <nav className="navDrawer" style={styles.navDrawer}>
      ...
      <NavLinks views={views} newView={newView} onClick={closeDrawer} style={styles.links}/>
      <SocialHandles />
    </nav>
  )
}
...
const Navs = ({ views, openDrawer, closeDrawer, open }) => {
  ...
  return (
    <div className="Nav">
      ...
      <NavDrawer views={views} open={open} closeDrawer={closeDrawer} newView={newView}/>
    </div>
  )
}
